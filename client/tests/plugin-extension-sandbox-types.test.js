...
test('extension sandbox contracts keep transport data untrusted and lifecycle disposable', () => {
  const source = [
    ...
    'const outboundRequest: ExtensionHostToSandboxMessageDto = {',
    "  protocolVersion: 1, type: 'request', id: 'host-1', method: 'command.invoke', args: null",
    '};',
    'sandbox.postMessage(outboundRequest);',
    'sandbox.postMessage({',
    "  protocolVersion: 1, type: 'initialize',",
    "  extension: { id: 'acme.typed', version: '1.0.0' },",
    "  apiVersion: '1.6.0', source: 'export function activate() {}',",
    "  localization: { locale: 'en', messages: {} }",
    '});',
    '// @ts-expect-error Initialization messages require identity, source, API, and localization DTOs.',
