...
const REQUIRED_RENDERER_INPUTS = [
  ...
  'completion-rules.ts',
  'renderer/compat/editor-rules-adapter.ts',
  ...
  'renderer/ai-ui-entry.ts',
  'renderer/temml-runtime.ts',
  'renderer/ai-ui-loader.ts',
  'src/ai-prompts.ts',
...
test('HTML has at most two startup scripts and the renderer build covers every former module', () => {
  ...
  for (const legacyModule of [
    ...
    'renderer/compat/collaboration-adapter.js',
    'src/runtime.js',
    ...
    'renderer/ai-ui-loader.js',
    'renderer/ai-ui-entry.js',
    'renderer/temml-runtime.js',
    'src/output-panel.js',
