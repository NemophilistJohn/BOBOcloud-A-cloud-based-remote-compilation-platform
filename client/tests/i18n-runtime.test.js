...
test('dynamic UI translation entry points reference defined English keys', () => {
  ...
  const sourceFiles = [
    'ai-agent-button.js', 'ai-chat-panel.js', 'ai-markdown.ts', 'ai-settings-center.js',
    ...
    'source-control-view.ts', 'agent-workbench.js', 'command-palette.ts', 'language-packs-panel.ts', 'file-search.js', 'settings.js', 'workspace-launch.ts', 'workspace.js', 'projects.ts', 'cache-center.ts', 'environment-center.ts', 'environment-center-model.ts', 'package-center.js', 'rclone-settings.ts'
  ];
