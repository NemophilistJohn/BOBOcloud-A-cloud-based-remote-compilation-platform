...
test('dynamic UI translation entry points reference defined English keys', () => {
  ...
  const sourceFiles = [
    ...
    'project-tasks.ts', 'workspace-sync-status.js', 'task-problem-matcher.js', 'runner.js', 'run-config.js', 'runtime.ts', 'dap-client.js', 'terminal.js', 'auth.js', 'plugin-manager-ui.ts', 'plugin-details.ts',
