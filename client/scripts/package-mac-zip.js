...
const asarPath = path.resolve(process.argv[3] || path.join(projectRoot, 'dist', 'win-unpacked', 'resources', 'app.asar'));
const outputDir = path.resolve(process.argv[4] || path.join(projectRoot, 'dist', 'mac'));
